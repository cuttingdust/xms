...
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_XMsgType_2eproto;
namespace google
{
    namespace protobuf
    {
...
namespace xmsg
{
    ...
    {
        static_assert(std::is_same<T, MsgType>::value || std::is_integral<T>::value,
    ...
    {
        return ::google::protobuf::internal::ParseNamedEnum<MsgType>(MsgType_descriptor(), name, value);
    }
